...
# Ensure GPU errors are captured
...
# Augmentation transforms (same as used earlier for consistency)
...
def train_model(model, dataloader, num_epochs=10):
    ...
    for epoch in range(num_epochs):
        ...
        scheduler.step()
        print(f"Epoch {epoch+1}, Avg Loss: {total_loss / len(dataloader):.4f}, LR: {scheduler.get_last_lr()[0]:.6f}")
